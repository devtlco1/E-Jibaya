-- =====================================================
-- E-Jibaya Simple Working Test
-- إنشاء مستخدم بكلمة مرور بسيطة للاختبار
-- =====================================================

-- حذف المستخدم إذا كان موجوداً
DELETE FROM public.users WHERE username = 'easy';

-- إنشاء مستخدم بكلمة مرور بسيطة
-- كلمة المرور: 123
INSERT INTO public.users (username, password_hash, full_name, role, is_active) VALUES
('easy', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4QZqJqJqJq', 'مستخدم بسيط', 'admin', true);

-- رسالة نجاح
DO $$
BEGIN
    RAISE NOTICE 'Simple working test user created!';
    RAISE NOTICE 'Username: easy';
