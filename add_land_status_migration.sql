...
-- القيم: متروك، مهدوم، لم اعثر عليه، ممتنع، تجاوز، قيد الانشاء، مبدل، مغلق، لايوجد مقياس، فحص مقياس، فارغ، خطاء في القرادة
-- =====================================================
...
BEGIN
    IF NOT EXISTS (
        ...
        COMMENT ON COLUMN public.collection_records.land_status IS 'حالة الارض: متروك، مهدوم، لم اعثر عليه، ممتنع، تجاوز، قيد الانشاء، مبدل، مغلق، لايوجد مقياس، فحص مقياس، فارغ، خطاء في القرادة';
        ...
        CHECK (land_status IS NULL OR land_status IN (
            ...
            'فحص مقياس', 'فارغ', 'خطاء في القرادة'
        ));
